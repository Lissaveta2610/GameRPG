...
public abstract class GameCharacter {
    ...
    float secondsPerFrame; //сколько сек длится кадр
    ...
    public void render(SpriteBatch batch, BitmapFont font24) {
        ...
        int frameIndex; //вычисляем чистоту кадра
        frameIndex = (int) (animationTimer / secondsPerFrame) % regions.length;
        ...
        //+ (int) (Math.sin(animationTimer * 10) * 15 * damageEffectTimer) - для скачущей полоски
    }
